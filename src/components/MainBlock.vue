  ...
  <div class="main-block">
    ...
    <div class="first">
      ...
      <div class="flex column items-center justify-center container">
        <p class="text-white text-h2 text-center text-weight-bold text-center" style="line-height: 80px">Мы обеспечиваем наилучшее <br>страховое обслуживание</p>
  ...
  data(){
    return{
      ...
      items:[
        ...
        {
          title: 'Set For Life',
          text: 'They were used to create the \n' +
